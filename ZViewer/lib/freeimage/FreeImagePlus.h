...
public:
	...
	*/
	...
	/** @brief Returns a pointer to the start of the given scanline in the bitmap뭩 data-bits.
	...
	*/
	...
	/**
	8-bit transparency : get the bitmap뭩 transparency table.
	@return Returns a pointer to the bitmap뭩 transparency table.
	@see FreeImage_GetTransparencyTable
	*/
	BYTE* getTransparencyTable() const;

	/** 
	8-bit transparency : set the bitmap뭩 transparency table.
